...
/**
 * Produtor responsável por enviar mensagens relacionadas a itens de entrega rápida de comida.
 * Implementa a interface Producer para fornecer a lógica de produção e envio de mensagens.
 */
public class FoodDeliveryProducer implements Producer {
    ...
    public FoodDeliveryProducer(String nameProducer ) {
        this.nameProducer = "Fast Delivery Producer";
    }
    /**
    ...
    public void sendMessage(String message) {
        ...
        FoodDeliveryProducer Producer = new FoodDeliveryProducer(message);
