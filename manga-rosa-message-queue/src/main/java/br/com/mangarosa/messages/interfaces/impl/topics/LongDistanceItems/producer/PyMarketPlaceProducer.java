package br.com.mangarosa.messages.interfaces.impl.topics.LongDistanceItems.producer;
...
public class PyMarketPlaceProducer implements Producer{
    ...
    public PyMarketPlaceProducer(String nameProducer ) {
        this.nameProducer = "PyMarket Place Producer";
    }
    /**
    ...
    public void sendMessage(String message) {
        ...
        PyMarketPlaceProducer Producer = new PyMarketPlaceProducer(message);
